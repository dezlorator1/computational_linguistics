...
def main():
    ...
    for i in range(1):
        ...
        for url in tqdm(all_links):
            ...
            update_write_mongo(news_collection, data)
        bar.finish()

def test():
    #data = get_page_data('https://bloknot-volgograd.ru/news/2-iyunya-volgogradskuyu-oblast-nakroet-silnaya-gro-1351294')
    html = get_html('https://bloknot-volgograd.ru/news/2-iyunya-volgogradskuyu-oblast-nakroet-silnaya-gro-1351294')
    data = get_page_data(html)
